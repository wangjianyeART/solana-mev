#!/usr/bin/env python3
"""
Wormhole NATIVE_TOKEN_TRANSFER 1年 SOL↔ETH

采集过去365天所有包含 NATIVE_TOKEN_TRANSFER 的跨链记录。
30天滑动窗口，双向采集。

用法:
    python wormhole_data/fetch_wormhole_ntt_1y.py
"""
...
def main():
    ...
    for win_start, win_end in windows:
        for direction in DIRECTIONS:
            ...
            print(f"  扫描{page_scanned} NTT+{kept} 累计{len(records):,} ({elapsed:.0f}s)")
