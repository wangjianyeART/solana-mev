...
$\sim\!1{,}009$~s ($\sim\!17$~min), a $\sim\!30\times$ asymmetry
...
tiers: $<\!60$~s ($n=14{,}086$, median $+1.42\%$) and
$60$--$300$~s ($n=2{,}360$, median $+1.08\%$) both outperform the
wider $300$~s--$1$~h tier ($n=13{,}913$, median $+1.54\%$), while
the $1$--$24$~h tier collapses to $+0.21\%$ and the $>\!24$~h tier
to $-1.17\%$. Panel~(c) is the direct univariate evidence for the
...
(ii)~$[-\$100,+\$500]$ contains $96.0\%$ of candidates
(only $2.3\%$ below, $1.7\%$ above), i.e.\ almost all samples keep
...
itself is right-skewed with median $+\$3.21$ and p75~$\approx+\$10$,
