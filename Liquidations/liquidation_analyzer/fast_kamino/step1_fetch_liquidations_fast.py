...
MAX_REQUESTS_PER_SECOND = 50  # 高级会员 50 req/sec
...
def fetch_liquidations_fast(limit: int = 5000, workers: int = 20, output_dir: str = "./data",
                            before: Optional[str] = None):
    """快速获取清算交易。before: 游标签名，传则从该签名之后（更早的历史）开始倒着拉。"""
    ...
    while len(all_signatures) < limit:
        ...
        before_cursor = sigs[-1]['signature']
